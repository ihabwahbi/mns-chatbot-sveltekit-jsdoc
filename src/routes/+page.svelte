...
<main class="flex h-[calc(100dvh)] flex-col">
	...
	{#if $authLoading}
		...
		<div class="flex flex-grow items-center justify-center bg-gradient-to-b from-cee5fd to-white">
			<div class="text-center">
				<div class="mb-4">
					<svg
						aria-hidden="true"
						class="mx-auto h-12 w-12 animate-spin fill-slbBlue text-gray-200"
						viewBox="0 0 100 101"
						fill="none"
				...
				<p class="text-lg text-slate-700">Authenticating...</p>
			</div>
		</div>
	{:else if !$userStore}
		...
		<div class="flex flex-grow items-center justify-center bg-gradient-to-b from-cee5fd to-white">
			<div class="text-center px-4">
				<h1 class="mb-4 text-3xl font-bold text-slate-900">Authentication Required</h1>
				<p class="mb-6 text-lg text-slate-700">
					Please sign in to access EchoEngine M&S
				</p>
				<a
					href="/.auth/login/aad"
